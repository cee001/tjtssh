    ...
    <script type="text/javascript">
	     ...
	     $(function(){   
	           ...
	           $.ajax({   	       		
				     ...
				     $("#pt2").html($("#pt2").html()+'<div style="width:198px;height:280px;float: left;overflow:hidden;border-left: 1px solid;border-left-color:#F2F2F2;border-bottom: 1px solid;border-bottom-color:#F2F2F2;">'	   
  ...
  <body>
   ...
   <div>
    <table border="1" bordercolor="#F2F2F2" align="center" style="border-collapse: collapse;width:100%;" cellpadding="0" cellspacing="0">   
          ...
          <td  colspan="2" style="font-size:15px;border-color: #ffffff;">
            <div style="font-size:15px;border-bottom:2px solid;border-bottom-color:  #3A5FCD;;height:40px;">
                <ul style="float: left;height:35px;">
                  <li style="float: left;margin-top: 5px;margin-left: 12px;font-size: 30px;color: #3A5FCD;"><b>2F</b></li>
                  <li style="float: left;margin-top: 15px;margin-left: 5px;font-size: 16px;"><b>理化检测仪器</b></li>
                </ul>
            </div>
          </td>   
      </tr>    
      <tr align="center">
        <td>
          <div id="pt2" style="font-size:15px;"></div>
        </td>     
      </tr>		
     </table>
    </div>
