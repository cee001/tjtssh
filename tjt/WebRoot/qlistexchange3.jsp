    ...
    <div id="xchange">
	    <table style="width:100%;line-height: 22px;">            	
	     <tr align="left" style="border-top:1px solid;border-top-color:#EAEAEA;">
	       <td colspan="2" style="height:23px;padding-left: 10px;font-size:15px;padding-top: 5px;background:url(images/TJT/dht.png);">考证交流</td>
	     </tr>
	     <tr align="center">	 
	       <td align="left"><div id="xchange4" style="padding-top: 5px;"></div></td>  
	     </tr>	
	    </table>
	</div>
  </body>
