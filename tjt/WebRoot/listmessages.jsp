       ...
       $(function(){    
	     ...
	     function getdata(m){  
	           ...
	           $.ajax({   
				     ...
				     $("#dmsgid2").html($("#dmsgid2").html()+'<div style="border-bottom:1px solid;border-bottom-color:#B2DFEE;font-size:13px;padding-left: 5px;"><a onclick="changeif(1)" href="msgcon.jsp?mid='+rdata.messagesId+'" target="tvc">'+rdata.messagesTitle+'</a></div>');
