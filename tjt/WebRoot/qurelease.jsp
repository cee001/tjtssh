    ...
    <script type="text/javascript">
	   ...
	   function reimg(){
        ...
        function showconr(){ 
              ...
              if(strimg!=null & strimg.length>5){
	                        ...
	                        <div>
	                            <ul style="padding: 0px;list-style-type: none;float: left">
	                                ...
	                                <li style="float: right;margin-left:364px;">
						                       <input id="ap1" type="button" class="bt11" value="发  表" onclick="showconr()" onmousemove="changep()" onmouseout="rechangep()"
						                              style="width:100px;height:25px;border:0px;color:#ffffff;font-size:14px;font-family: 微软雅黑"> 
