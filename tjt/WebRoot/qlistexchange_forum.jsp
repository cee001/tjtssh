...
<html>
  <head>
    ...
    <script>
	     ...
	     function getdata(m){  
    		 ...
    		 var tid= document.getElementById("iptid1").value; 
             if(m==1 & n!=1){
             n=n-2;
             }   
			     ...
			     $(data3).each(function(index,rdata){		
		           ...
		           $.ajax({   
                    ...
                    msgtime=msgtime.substring(0,16);      
				     ...
				     +'href="qforum_news.jsp?dd=qnews1.jsp?mid='+rdata.messagesId+'" target="blank">'+datatitle+'</a></li>'
  ...
  <body>
    ...
    %>
    <input id="iptid1" type="hidden" value="<%=tid %>">
    <div id="xchange">
	    <table style="width:100%;line-height: 25px;font-size:15px;color:#CD9B1D;">            
	     ...
	     <tr style="border-top:1px solid;border-top-color:#CD9B1D;">	 
	       <td align="left" colspan="4"><div id="xchange1" style="padding-top: 10px;">数据加载中。。。</div></td>  
	     </tr>	
	     <tr  style="border-top:1px solid;border-top-color:#CD9B1D;">	 
	       <td colspan="4">
