        ...
        function showconr(){ 
		  ...
		  $.ajax({
       	   ...
       	   function GetJsonData() {
	            ...
	            var strfile="";
	            var urlname= fileUrl.split('#!!')[0];
	            if(urlname.length>24){
	            strfile=fileUrl.substring(4); 
	            }else{
	...
	<body>
      ...
      <tr >
        ...
        <div style="float: left">           
            ...
            <select id="meg13" name="messagestypeId" onclick="clearl()">	
      ...
      <tr >     
         ...
         <div style="width:100%;height:25px;">
	         ...
	         <input id="insertfile"  type="button" value="选择文件" onclick="clearl()"
