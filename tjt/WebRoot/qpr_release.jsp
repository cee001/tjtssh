  ...
  <body>
    ...
    <div id="indexdiv"> 
       ...
       <div id="divp2" onmouseover="rechangex1()">
	       ...
	       <div style="visibility: visible;position:absolute;width:1000px;height:1000px;overflow:hidden;">
             <iframe frameborder="0" style="width:100%;height:1200px;margin-top:0px;" src="qpr_release1.jsp"></iframe>     
	         
	       </div>
 
           <div id="divp21" style="width:997px;margin-top: 1000px;overflow:hidden;"></div>
