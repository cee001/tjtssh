...
String savePath ="/home/default/TJT/data/";
//文件保存目录URL /zswz/attached/
String saveUrl ="/home/default/TJT/";  
//定义允许上传的文件扩展名
//定义允许上传的文件扩展名
...
//获取文件输出流
FileOutputStream fos = new FileOutputStream("/home/default/TJT/data/"+ newImgName);
//获取内存中当前文件输入流
...
obj.put("error", 0);
obj.put("url",""+ newImgName+"#!!"+fileName);
