...
public class CompanyService {
	...
	public TCompany getTCompanyByUid(int uid){
		TCompany u=null;
		String hql="from TCompany where user_id="+uid;
		@SuppressWarnings("rawtypes")
		List ls=cd.getObjects(hql);
		if(ls!=null&&ls.size()>0){
			System.out.println("��½�ɹ���");
