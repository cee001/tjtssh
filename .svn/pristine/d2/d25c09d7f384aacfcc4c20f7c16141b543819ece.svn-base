    ...
    <script type="text/javascript">
	     ...
	     $(function(){   
	           ...
	           $.ajax({   	       		
				     ...
				     $("#pt6").html($("#pt6").html()+'<div style="width:199px;height:260px;float: left;overflow:hidden;">'	   
  ...
  <body>
   ...
   <div>
    <table border="1" bordercolor="#4A708B" align="center" style="border-collapse: collapse;width:100%;" cellpadding="0" cellspacing="0">   
          ...
          <td>
            <div style="font-size:15px;border-bottom:1px solid;border-bottom-color: #4A708B;">
                <ul style="float: left;height:35px;">
                  <li style="float: left;margin-top: 5px;margin-left: 12px;font-size: 23px;"><b>6F</b></li>
                  <li style="float: left;margin-top: 10px;margin-left: 5px;font-size: 15px"><b>特种设备实训考核设备</b></li>
                </ul>
            </div>
          </td>   
      </tr>    
      <tr align="center">
        <td>
          <div id="pt6" style="font-size:15px;padding-top: 5px;"></div>
        </td>     
      </tr>		
     </table>
    </div>
