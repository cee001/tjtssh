...
<script type="text/javascript">
 ...
 <body bgcolor="#ffffff">
    ...
    <tr>
       <td align="right" width="48%" bgcolor="#F8F8FF">设备所有人:</td>
       <td style="padding-left: 20px;">${de.TUserByUserId.userNikename}</td>
    </tr>

     <tr>
        <td align="right"  bgcolor="#F8F8FF">设备名称:</td>
        <td style="padding-left: 20px;">${de.deviceName}</td>
     </tr>
     <tr>
        <td  align="right" bgcolor="#F8F8FF" >录入时间:</td>
        <td style="padding-left: 20px;">${de.deviceFirsttime}</td>
     </tr>
     <tr>
        <td  align="right" bgcolor="#F8F8FF" >录入人员:</td>
        <td style="padding-left: 20px;">${de.TUserByCreateuserId.userNikename}</td>
     </tr>

     <tr>        
        <td colspan="2" align="center"><img src="http://xheyou.com/API/images/${de.deviceFaceimg }"></td>
     </tr>                 		  
     <tr>        
