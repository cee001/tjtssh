	           ...
	           $.ajax({   
				     ...
				     success:function(d){
							     ...
							     $(data3).each(function(index,rdata){			
									     ...
									     //$("#dmsgid2").html($("#dmsgid2").html()+'<div style="border-bottom:1px solid;border-bottom-color:#B2DFEE;font-size:13px;"><input id="'+i+'" type="hidden" value="'+rdata.messagesAnnex+'"><a onclick="downfile('+i+')" href="" target="tvc">'+rdata.messagesTitle+'</a></div>');
									     ...
									     //$("#dmsgid2").html($("#dmsgid2").html()+'<div style="border-bottom:1px solid;border-bottom-color:#B2DFEE;font-size:13px;"><input id="'+i+'" type="hidden" value="'+rdata.messagesAnnex+'"><a href="jsp/do_download.jsp" target="tvc">'+rdata.messagesTitle+'</a></div>');
             ...
             if(confirm("确定删除吗？")){
                $.ajax({
				       ...
				       success:function(d){	
		                          ...
		                          window.location.href="listStandard.jsp";
