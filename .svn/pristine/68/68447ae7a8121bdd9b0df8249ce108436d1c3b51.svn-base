...
<html>
    ...
    <script>      
        $(function(){    
	           ...
	           $.ajax({   
                     ...
                     if(datatitle.length>21){
                       datatitle=datatitle.substring(0, 20)+"..";
                     }	
				     $("#supdem100").html($("#supdem100").html()+'<div><ul style="padding:0px;width:298px;height:25px;"><li style="float: left;padding:0px;width:10px;text-align: right;height:24px"><b style="color:#7F7F7F;">·</b></li><li title="'+strtitle+'" style="float: right;padding:0px;width:280px;height:25px;font-size:14px;"><a style="font-weight: 200;" href="msgcon.jsp?mid='+rdata.messagesId+'" >'+datatitle+'</a></li></ul></div>');
  ...
  <body >
    ...
    <div>
	    <table style="width:300px;line-height: 25px;font-size:15px;">            
