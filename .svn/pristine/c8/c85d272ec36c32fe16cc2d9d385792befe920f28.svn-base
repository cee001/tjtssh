             ...
             if(confirm("确定删除吗？")){
                $.ajax({
				       ...
				       success:function(d){	
		                          ...
		                          window.location.href="listsupdem.jsp";
        ...
        $(function(){    
	     ...
	     function getdata(m){  
	           ...
	           $.ajax({   
				     ...
				     $("#dmsgid3").html($("#dmsgid3").html()+'<div style="border-bottom:1px solid;border-bottom-color:#B2DFEE;font-size:13px;padding-left: 5px;"><a onclick="changeif(1)" href="msgcon.jsp?mid='+rdata.messagesId+'" target="tvc">'+datatitle+'</a></div>');
  ...
  <body >
   ...
   <div id="dvmsgid">
    <table   border="1" bordercolor="#B2DFEE" align="center" style="border-collapse: collapse;width:100%;line-height: 25px;font-size:15px;" cellpadding="0" cellspacing="0">   
	       ...
	       <div id="dvif1" style="display: none;width:100%;">
               ...
               <div  style="margin-top: 0px;margin-left: 0px;padding0pxtext-align: right;width:100%;"> 
                  <ul style="padding: 0px;margin-top:0px;list-style-type: none;float: right;width:100%;background:#F8F8FF;border-bottom:1px solid;border-bottom-color:#B2DFEE;">
                   ...
                   <li style="margin-right: 47%;float: right;color:#5B5B5B"><b>信息详情</b></li>
                  </ul>             
	          </div>
     ...
     <td><div id="dmsgid3" align="left"></div></td>
